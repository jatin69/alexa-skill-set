  ...
  'LaunchRequest': function() {
    if(Object.keys(this.attributes).length === 0) {
        ...
        this.response
            ...
            'Which language would you like to practice?').listen();
    ...
    if (userAnswer == correctAnswer){
        ...
        this.response
          .speak('Nice job! The correct answer is ' + correctAnswer + '. You ' +
            ...
            currentLanguage + ' questions correct. Here is your next question. ' + this.AskQuestion(this.attributes))
          .listen(this.AskQuestion(this.attributes));
    } else {
        var numberCorrect = this.attributes.flashcards.languages[currentLanguage].numberCorrect;
        this.response
          ...
          currentLanguage + ' questions correct. Here is your next question.' + 
                 this.AskQuestion(this.attributes)).listen(this.AskQuestion(this.attributes));
    }
